...
/**
 * Exception class to indicate that the number of rows processed in the database is not one.
 * 
...
public class NotSingleRowExceptionClass {
     ...
     */
    private static final String CONSTRUCTOR_JAVADOC = "Create an instance of the exception object to indicate that the number of rows processed is not the expected one.";
    ...
    public BlancoCgSourceFile expand() {
...

        {
            ...
            listDesc.add("Exception class to indicate that the number of rows processed in the database is not one <br>");
