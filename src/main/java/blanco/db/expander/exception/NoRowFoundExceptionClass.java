...
/**
 * Exception class to indicate that no rows of data were retrieved as a result of database processing.
 * 
...
public class NoRowFoundExceptionClass {
     ...
     */
    private static final String CONSTRUCTOR_JAVADOC = "Creates an instance of the exception class to indicate that no rows of data were retrieved as a result of database processing.";
    ...
    public BlancoCgSourceFile expand() {
...

        {
            ...
            listDesc.add("Exception class to indicate that no rows of data were retrieved as a result of database processing <br>");
