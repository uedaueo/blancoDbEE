...
/**
 * Exception class for database timeouts.
 * 
...
public class TimeoutExceptionClass {
     ...
     */
    private static final String CONSTRUCTOR_JAVADOC = "Creates an instance of the exception object to indicate that a database timeout has occurred.";
    ...
    public BlancoCgSourceFile expand() {
...

        {
            ...
            listDesc.add("Exception class for database timeouts <br>");
