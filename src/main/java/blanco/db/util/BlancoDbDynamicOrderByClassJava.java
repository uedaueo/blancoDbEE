...
public class BlancoDbDynamicOrderByClassJava {
    ...
    public BlancoCgSourceFile expand() {
...

        {
            ...
            listDesc.add("A class that defines a dynamically generated ORDERBY clause.");
            listDesc.add("");
...

        {
            ...
            cgClass.getFieldList().add(
                    buildField("column", "Column name to use for sort order", "java.lang.String", null)
            );
            cgClass.getFieldList().add(
                    buildField("order", "Specifies ascending or descending order.", "java.lang.String", null)
            );
        }

        {
            /* Getter/Setter */
            cgClass.getMethodList().add(
                    buildMethodSet("column", "Column name to use for sort order", "java.lang.String", null)
            );
            cgClass.getMethodList().add(
                    buildMethodGet("column", "Column name to use for sort order", "java.lang.String", null)
            );

            cgClass.getMethodList().add(
                    buildMethodSet("order", "Specifies ascending or descending order.", "java.lang.String", null)
            );
            cgClass.getMethodList().add(
                    buildMethodGet("order", "Specifies ascending or descending order.", "java.lang.String", null)
            );
        }
    ...
    private BlancoCgMethod buildConstructor(String type) {
        ...
        cgMethod.getParameterList().add(
                fCgFactory.createParameter("argColumn", "java.lang.String", "Column name to use for sort order"));
        lineList.add("this.column = argColumn;");

        cgMethod.getParameterList().add(
                fCgFactory.createParameter("argOrder", "java.lang.String", "Specifies ascending or descending order."));
