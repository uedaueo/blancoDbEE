 ...
 */
public class SimpleUserUpdateInvoker {
    /**
    ...
    /**
     * SimpleUserUpdateInvokerConstructor for the class.
     *
     ...
     */
    public SimpleUserUpdateInvoker(final Connection conn) {
        fConnection = conn;
    }
     ...
     */
    @Deprecated
    public SimpleUserUpdateInvoker() {
    }

    /**
     * SimpleUserUpdateInvokerSets a database connection to the class.
     *
     * @param conn Database connection
     */
    @Deprecated
    ...
    public String getQuery() {
        return "UPDATE user\n   SET password = ?, created_at = ?, updated_at = ?\n WHERE user_id = ?";
    }
     ...
     * @throws SQLException If an SQL exception occurs.
     */
    public void setInputParameter(final String password, final Date createdAt, final Date updatedAt, final String whereUserId) throws SQLException {
        if (fStatement == null) {
            prepareStatement();
        }
    ...
    protected void finalize() throws Throwable {
        super.finalize();
        if (fStatement != null) {
            final String message = "SimpleUserUpdateInvoker : The resource has not been released by the close() method.";
