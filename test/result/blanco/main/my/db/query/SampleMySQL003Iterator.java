...
public class SampleMySQL003Iterator {
    ...
    /**
     * SampleMySQL003IteratorConstructor for the class.
     *
     ...
     */
    public SampleMySQL003Iterator(final Connection conn) {
        fConnection = conn;
    }
     ...
     */
    @Deprecated
    public SampleMySQL003Iterator() {
    }

    /**
     * SampleMySQL003IteratorSets a database connection to the class.
     *
     * @param conn Database connection
     */
    @Deprecated
     ...
     * @throws SQLException If an SQL exception occurs.
     */
    public SampleMySQL003Row getRow() throws SQLException {
        SampleMySQL003Row result = new SampleMySQL003Row();
     ...
     *
     * The list will contain the SampleMySQL003 class.<br>
     ...
     * @return SampleMySQL003Class List, which will return an empty list if the search results are zero.
     * @throws SQLException If an SQL exception occurs.
     */
    public List<SampleMySQL003Row> getList(final int size) throws SQLException {
        List<SampleMySQL003Row> result = new ArrayList<SampleMySQL003Row>(8192);
    ...
    protected void finalize() throws Throwable {
        super.finalize();
        if (fStatement != null) {
            final String message = "SampleMySQL003Iterator : The resource has not been released by the close() method.";
