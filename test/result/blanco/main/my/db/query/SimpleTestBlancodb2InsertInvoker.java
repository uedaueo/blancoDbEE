...
/**
 * [SimpleTestBlancodb2Insert]  (QueryInvoker)
 *
 ...
 */
public class SimpleTestBlancodb2InsertInvoker {
    /**
    ...
    /**
     * SimpleTestBlancodb2InsertInvokerConstructor for the class.
     *
     ...
     */
    public SimpleTestBlancodb2InsertInvoker(final Connection conn) {
        fConnection = conn;
    }
     ...
     */
    @Deprecated
    public SimpleTestBlancodb2InsertInvoker() {
    }

    /**
     * SimpleTestBlancodb2InsertInvokerSets a database connection to the class.
     *
     * @param conn Database connection
     */
    @Deprecated
     ...
     * @throws SQLException If an SQL exception occurs.
     */
    public void setInputParameter(final int colId, final BigDecimal colNumeric) throws SQLException {
        if (fStatement == null) {
            prepareStatement();
        }
    ...
    protected void finalize() throws Throwable {
        super.finalize();
        if (fStatement != null) {
            final String message = "SimpleTestBlancodb2InsertInvoker : The resource has not been released by the close() method.";
