...
/**
 * [SimpleTokenUpdate]  (QueryInvoker)
 *
 ...
 */
public class SimpleTokenUpdateInvoker {
    /**
    ...
    /**
     * SimpleTokenUpdateInvokerConstructor for the class.
     *
     ...
     */
    public SimpleTokenUpdateInvoker(final Connection conn) {
        fConnection = conn;
    }
     ...
     */
    @Deprecated
    public SimpleTokenUpdateInvoker() {
    }

    /**
     * SimpleTokenUpdateInvokerSets a database connection to the class.
     *
     * @param conn Database connection
     */
    @Deprecated
    ...
    public String getQuery() {
        return "UPDATE token\n   SET token = ?, expired_at = ?, created_at = ?, updated_at = ?\n WHERE user_id = ?";
    }
     ...
     * @param whereUserId Value in 'whereUserId' column
     * @throws SQLException If an SQL exception occurs.
     */
    public void setInputParameter(final String token, final Date expiredAt, final Date createdAt, final Date updatedAt, final String whereUserId) throws SQLException {
        if (fStatement == null) {
            prepareStatement();
        }
        ...
        fStatement.setString(index, whereUserId);
        index++;
    ...
    protected void finalize() throws Throwable {
        super.finalize();
        if (fStatement != null) {
            final String message = "SimpleTokenUpdateInvoker : The resource has not been released by the close() method.";
