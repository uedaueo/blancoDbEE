 ...
 */
public class SimpleUserInsertInvoker {
    /**
    ...
    /**
     * SimpleUserInsertInvokerConstructor for the class.
     *
     ...
     */
    public SimpleUserInsertInvoker(final Connection conn) {
        fConnection = conn;
    }
     ...
     */
    @Deprecated
    public SimpleUserInsertInvoker() {
    }

    /**
     * SimpleUserInsertInvokerSets a database connection to the class.
     *
     * @param conn Database connection
     */
    @Deprecated
    ...
    public String getQuery() {
        return "INSERT\n  INTO user\n       (user_id, password, created_at, updated_at)\nVALUES\n       (?, ?, ?, ?)";
    }
     ...
     * @throws SQLException If an SQL exception occurs.
     */
    public void setInputParameter(final String userId, final String password, final Date createdAt, final Date updatedAt) throws SQLException {
        if (fStatement == null) {
            prepareStatement();
        }
    ...
    protected void finalize() throws Throwable {
        super.finalize();
        if (fStatement != null) {
            final String message = "SimpleUserInsertInvoker : The resource has not been released by the close() method.";
