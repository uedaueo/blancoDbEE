 ...
 */
public class SimpleTestBlancodbInsertInvoker {
    /**
    ...
    /**
     * SimpleTestBlancodbInsertInvokerConstructor for the class.
     *
    ...
    /**
     * SimpleTestBlancodbInsertInvokerSets a database connection to the class.
     *
     * @param conn Database connection
     */
    @Deprecated
    ...
    protected void finalize() throws Throwable {
        super.finalize();
        if (fStatement != null) {
            final String message = "SimpleTestBlancodbInsertInvoker : The resource has not been released by the close() method.";
