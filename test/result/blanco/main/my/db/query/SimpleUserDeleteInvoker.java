 ...
 */
public class SimpleUserDeleteInvoker {
    /**
    ...
    /**
     * SimpleUserDeleteInvokerConstructor for the class.
     *
     ...
     */
    public SimpleUserDeleteInvoker(final Connection conn) {
        fConnection = conn;
    }
     ...
     */
    @Deprecated
    public SimpleUserDeleteInvoker() {
    }

    /**
     * SimpleUserDeleteInvokerSets a database connection to the class.
     *
     * @param conn Database connection
     */
    @Deprecated
    ...
    protected void finalize() throws Throwable {
        super.finalize();
        if (fStatement != null) {
            final String message = "SimpleUserDeleteInvoker : The resource has not been released by the close() method.";
