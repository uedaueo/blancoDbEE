...
public class SampleMySQL005Row {
    ...
    public String toString() {
        ...
        buf.append("my.db.row.SampleMySQL005Row[");
        buf.append("ID=" + fId);
     ...
     */
    public void copyTo(final SampleMySQL005Row target) {
        if (target == null) {
            throw new IllegalArgumentException("Bug: SampleMySQL005Row#copyTo(target): argument 'target' is null");
        }
        ...
        // Name: fText
        // Type: java.io.Reader
        // Field[fText] is an unsupported type[java.io.Reader].
        // Name: fMyNUMERIC
