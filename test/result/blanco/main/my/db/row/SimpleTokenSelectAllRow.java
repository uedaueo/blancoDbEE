 ...
 *
 * 'SimpleTokenSelectAllRow' row is represented.
 ...
 */
public class SimpleTokenSelectAllRow {
    /**
     * Field [user_id].
     *
     * フィールド: [user_id]。
    ...
    public String toString() {
        ...
        buf.append("my.db.row.SimpleTokenSelectAllRow[");
     ...
     */
    public void copyTo(final SimpleTokenSelectAllRow target) {
        if (target == null) {
            throw new IllegalArgumentException("Bug: SimpleTokenSelectAllRow#copyTo(target): argument 'target' is null");
        }
