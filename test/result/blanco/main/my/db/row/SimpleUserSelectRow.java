 ...
 *
 * 'SimpleUserSelectRow' row is represented.
 ...
 */
public class SimpleUserSelectRow {
    /**
     * Field [user_id].
     *
     * フィールド: [user_id]。
    ...
    public String toString() {
        ...
        buf.append("my.db.row.SimpleUserSelectRow[");
     ...
     */
    public void copyTo(final SimpleUserSelectRow target) {
        if (target == null) {
            throw new IllegalArgumentException("Bug: SimpleUserSelectRow#copyTo(target): argument 'target' is null");
        }
