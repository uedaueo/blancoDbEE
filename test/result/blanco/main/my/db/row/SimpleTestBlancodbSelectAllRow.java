...
public class SimpleTestBlancodbSelectAllRow {
     ...
     */
    public void copyTo(final SimpleTestBlancodbSelectAllRow target) {
        if (target == null) {
            throw new IllegalArgumentException("Bug: SimpleTestBlancodbSelectAllRow#copyTo(target): argument 'target' is null");
        }
