 ...
 *
 * 'SimpleTestBlancodbColumnColTextRow' row is represented.
 * (1) 'COL_TEXT' column type:java.io.Reader
 */
public class SimpleTestBlancodbColumnColTextRow {
    /**
     * Field [COL_TEXT].
     *
     * フィールド: [COL_TEXT]。
    ...
    public String toString() {
        ...
        buf.append("my.db.row.SimpleTestBlancodbColumnColTextRow[");
     ...
     */
    public void copyTo(final SimpleTestBlancodbColumnColTextRow target) {
        if (target == null) {
            throw new IllegalArgumentException("Bug: SimpleTestBlancodbColumnColTextRow#copyTo(target): argument 'target' is null");
        }
