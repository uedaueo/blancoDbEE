...
public class SampleMySQL003Iterator {
    ...
    /**
     * SampleMySQL003Iteratorクラスのコンストラクタ。
     *
    ...
    /**
     * SampleMySQL003Iteratorクラスにデータベース接続を設定。
     *
     * @param conn データベース接続
     */
    @Deprecated
     ...
     * 検索結果をリストの形式で取得します。
     *
     * リストには SampleMySQL003クラスが格納されます。<br>
     ...
     * @return SampleMySQL003クラスのList。検索結果が0件の場合には空のリストが戻ります。
     * @throws SQLException SQL例外が発生した場合。
     */
    ...
    protected void finalize() throws Throwable {
        super.finalize();
        if (fStatement != null) {
            final String message = "SampleMySQL003Iterator : close()メソッドによるリソースの開放が行われていません。";
