...
/**
 * Exception class to indicate that more than one row of data has been changed as a result of database processing <br>
...
public class TooManyRowsModifiedException extends NotSingleRowException {
    ...
    /**
     * Creates an instance of the exception class to indicate that more than one row of data has been changed as a result of database processing.
     *
