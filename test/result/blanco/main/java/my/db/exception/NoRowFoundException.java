...
/**
 * Exception class to indicate that no rows of data were retrieved as a result of database processing <br>
...
public class NoRowFoundException extends NotSingleRowException {
    ...
    /**
     * Creates an instance of the exception class to indicate that no rows of data were retrieved as a result of database processing.
     *
